...
```markdown
[Example](https://www.example.com){:target="_ blank"}
```
...
And then, I find [this](https://discourse.gohugo.io/t/do-you-set-target-blank-for-external-links/37579) which saves my life. I'll just show how to do it directly, you can go to learn more if you have interest.
